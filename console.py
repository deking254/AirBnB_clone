...
class HBNBCommand(cmd.Cmd):
    ...
    def do_fAmenity(self, args):
        ...
        if args == '.all()':
            ...
            if len(to_tuple) > 0:
                if type(to_tuple) == str:
                    show_instance = "Amenity " + to_tuple
                else:
